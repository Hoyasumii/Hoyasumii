...
> ![](https://skillicons.dev/icons?i=nodejs,ts,nestjs,next,vitest,prisma,redis,react,tailwind,sass,express,bun,elysia,postgresql,mongo,python,docker,githubactions)
